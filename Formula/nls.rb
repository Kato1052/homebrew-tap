...
class Nls < Formula
  ...
  if OS.mac? && Hardware::CPU.arm?
    url "https://github.com/Kato1052/nls/releases/download/v0.0.8/nls-0.0.8_arm64_darwin.tar.gz"
    sha256 "c08a4b28413f7b8f757baded90b87b2620acdf4617e18f18f800a6a09b521580"
  end
  if OS.linux? && Hardware::CPU.arm?
    url "https://github.com/Kato1052/nls/releases/download/v0.0.8/nls-0.0.8_arm64_linux.tar.gz"
    sha256 "a11d0014fe549d113c5e9fe018671511f5be05c1b69f458cc1990eca003659c9"
  end
  if OS.mac? && Hardware::CPU.intel?
    url "https://github.com/Kato1052/nls/releases/download/v0.0.8/nls-0.0.8_amd64_darwin.tar.gz"
    sha256 "2414df8d8eb4d2db9cb6f341da5ef1dddff236c335cadfc57d7aa152d83c687b"
  end
  if OS.linux? && Hardware::CPU.intel?
    url "https://github.com/Kato1052/nls/releases/download/v0.0.8/nls-0.0.8_amd64_linux.tar.gz"
